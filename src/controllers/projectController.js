...
const createProject = async (req, res) => {
  try {
    const { title, description, projectType, skillsRequired, budget, deadline, isPublic } = req.body;
...
const updateProject = async (req, res) => {
  try {
    ...
    const { title, description, projectType, status, skillsRequired, budget, deadline, isPublic } = req.body;
...
const searchProjects = async (req, res) => {
  try {
    const { keyword, projectType, status, minBudget, maxBudget, skill } = req.query;
